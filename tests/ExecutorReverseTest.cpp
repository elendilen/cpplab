...
#include "PoseEq.hpp"
namespace adas{
    TEST(ExecutorFastTest,should_return_x_minis_1_given_status_is_reverse_command_is_M_and_facing_is_E)
    {
    ...
    TEST(ExecutorFastTest,should_return_y_minis_1_given_command_is_BBM_and_facing_is_N)
    {
